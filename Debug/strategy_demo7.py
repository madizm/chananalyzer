...
def build_parent_level_context(code: str, begin_time: str, end_time: Optional[str]) -> Tuple[List[str], Dict[str, Dict[str, float]]]:
    ...
    for parent_snapshot in parent_chan.step_load():
        ...
        context = {
            ...
            "parent_turnrate": trade_metric(last_klu, DATA_FIELD.FIELD_TURNRATE) or 0.0,
            "parent_turnrate_ratio_5": ratio_to_recent_avg(parent_klus, pos, DATA_FIELD.FIELD_TURNRATE, 5),
